...
The exact Lighttpd package checks, reference-X2000 web/Fluidd/camera observations, and 2026.2.a reset/reboot results are preserved in [managed-app and web qualification](../research/docs/apps-web-qualification.md). The current service and ownership contract above remains the operational reference.
